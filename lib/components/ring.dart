...
class _GlowingRingState extends State<GlowingRing>
  ...
  final double targetPercentage = 0.36; // Percentage in decimal (36%)
  ...
  void initState() {
    ...
    _controller = AnimationController(
      vsync: this,
      duration: Duration(seconds: 4), // Total animation duration
    );

    // Animation to rotate for 2 full spins and stop at the percentage
    _animation = Tween<double>(
      begin: 0,
      end: 2 + targetPercentage, // 2 full rotations + final percentage
